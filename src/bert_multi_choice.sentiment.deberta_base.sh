...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embedding/experiment-results/sentiment/deberta-base-naiive-concat/%x-%j.log
#SBATCH --job-name=sentiment-deberta-v3-base
...
out_model_name_or_path=deberta-base
...
do  
    ...
    do  
        ...
        do  
            ...
            echo $output_fn
            pred_fn_path=../experiment-results/$dataset/deberta-base-naiive-concat/$output_fn.jsonl
