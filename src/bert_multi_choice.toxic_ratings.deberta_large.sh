...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embeddings/experiment-results/toxic-ratings/deberta-large/%x-%j.log
#SBATCH --job-name=toxic_ratings
...
do  
    ...
    do  
        ...
        do  
            ...
            echo $output_fn
            pred_fn_path=../experiment-results/$dataset/deberta-large/$output_fn.jsonl
