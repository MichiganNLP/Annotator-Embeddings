...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embedding/experiment-results/sentiment/roberta-large-naiive-concat/%x-%j.log
#SBATCH --job-name=sentiment-roberta-large
...
do  
    ...
    do  
        ...
        do  
            ...
            echo $output_fn
            pred_fn_path=../experiment-results/$dataset/roberta-large-naiive-concat/$output_fn.jsonl
