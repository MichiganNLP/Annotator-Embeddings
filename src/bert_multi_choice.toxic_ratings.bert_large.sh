...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embeddings/experiment-results/toxic-ratings/bert-large/%x-%j.log
#SBATCH --job-name=toxic_ratings
#SBATCH --account=mihalcea0
#SBATCH --mail-user=dnaihao@umich.edu
#SBATCH --mail-type=ALL
#SBATCH --dependency=afterany:61592577_8
#SBATCH --array=6-7
...
do  
    ...
    do  
        ...
        #     echo $output_fn
        #     pred_fn_path=../experiment-results/$dataset/bert-large/$output_fn.jsonl
