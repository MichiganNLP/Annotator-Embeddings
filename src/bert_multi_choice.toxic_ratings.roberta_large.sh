...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embeddings/experiment-results/toxic-ratings/roberta-large/%x-%j.log
#SBATCH --job-name=toxic_ratings_roberta-large
...
do  
    ...
    do  
        ...
        do  
            ...
            echo $output_fn
            pred_fn_path=../experiment-results/$dataset/roberta-large/$output_fn.jsonl
