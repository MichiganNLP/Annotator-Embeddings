...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embeddings/experiment-results/friends_qia/roberta-base/%x-%j.log
...
do  
    ...
    do  
        ...
        do  
            ...
            echo $output_fn
            pred_fn_path=../experiment-results/$dataset/roberta-base/$output_fn.jsonl
