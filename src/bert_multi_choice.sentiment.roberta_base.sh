...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embedding/experiment-results/sentiment/roberta-base-naiive-concat/%x-%j.log
#SBATCH --job-name=sentiment-roberta-base
...
do  
    ...
    do  
        ...
        do  
            ...
            echo $output_fn
            pred_fn_path=../experiment-results/$dataset/roberta-base-naiive-concat/$output_fn.jsonl
