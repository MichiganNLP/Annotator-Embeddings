...
#SBATCH --output=/home/dnaihao/dnaihao-scratch/annotator-embeddings/experiment-results/friends_qia/deberta-large/%x-%j.log
#SBATCH --job-name=indirect_ans
